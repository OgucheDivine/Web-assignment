...
function create(){
    ...
    ele.innerHTML=`<img src="https://oguchedivine.github.io/Web-assignment/check.svg" onclick="checker(this)" height=3.8% width=3.8% > ${input.value}<img src="bin.svg" height="3.9%" width="3.63%" onclick="this.parentNode.remove()">`
